function output=cs_test_uniform_rayleigh(input)
...
%
%call:    cs_test_uniform_rayleigh(Input)
%
%input:   Input
...
%
%remarks: - Uses the standard Rayleigh test.
...
if length(input)<1
    error('cs_test_uniform_rayleigh: Insufficient input data.');
end
